...
### Additional Research
Another approach to textmining, in addition to topic modelng, is clustering. I wanted to compare how both approaches would work for my problem, namely, how the resulting list of technolgies would look like when generated by topic modeling methods and when gnerated by clustering methods.
The resulting visualization is [here](file:///Users/Elena/Documents/Career/Data%20Science/Metis/MetisGitHub/Jupyter/ProjectStartup1/Viz/D3_dimple/KMeansTechInnovations2_%20.html).
In general, my conclusion was that topic modeling performed better, the resulting list turned out to be cleaner and more comprehensive. I used only nouns for clustering in hope to identify technologies that might be missed by topic modeling that used the entire texts. It didn't happnen. On the contrary, I only lost some of the important trends such as "Mobile" and "Social". 
